...
| DEF-6 | Live ToS re-verification for Semantic Scholar / NCBI | Licensing table in risk-findings.md is stated from general domain knowledge of these programs' public policies, not re-verified against live current ToS pages. Not legal advice. | risk-findings.md Confidence section |
