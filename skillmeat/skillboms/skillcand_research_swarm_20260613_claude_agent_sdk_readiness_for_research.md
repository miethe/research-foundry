---
id: skillcand_research_swarm_20260613_claude_agent_sdk_readiness_for_research
name: 'Research Swarm — Claude Agent SDK readiness for Research Foundry: skills API, subagent API, and
...
performance_evidence:
  ccdash_event_id: exec_20260613_intent_research_20260613_what_is_the_eab0
  quality_score: pending
  rework_count: 0
  estimated_cost_usd: 0.0
---

# SkillBOM Candidate: Research Swarm — Claude Agent SDK readiness for Research Foundry: skills API, subagent API, and Python package stability
...
- CCDash event id: exec_20260613_intent_research_20260613_what_is_the_eab0
