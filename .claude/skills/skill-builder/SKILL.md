...
- Registration: `.claude/specs/skills-index.md`
...
Complete all required sections: Purpose & Scope, Capability Coverage, Invariants & Constraints, Enhancement Backlog, Changelog, Integration Points, and Success Signals. Register the skill in `.claude/specs/skills-index.md` once SPEC.md is complete.
