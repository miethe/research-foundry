...
owners: ["python-backend-engineer", "ui-engineer", "documentation-writer", "changelog-generator"]
contributors: []

tasks:
  - id: "ACT-601"
    description: "Unit + integration test suite (cross-phase) — deployment-mode resolver, token lifecycle, PAT role-ceiling, agent-job identity binding, AC-4 end-to-end"
    status: "pending"
    assigned_to: ["python-backend-engineer"]
    dependencies: ["P2 sealed", "P3 sealed", "P4 sealed"]
  - id: "ACT-602"
    description: "[SEAM] E2E smoke: admin UI issue->revoke round-trip against live API with deployment_mode=multi_user"
    status: "pending"
    assigned_to: ["python-backend-engineer", "ui-engineer"]
    dependencies: ["ACT-601", "P5 sealed"]
  - id: "ACT-603"
    description: "Update CHANGELOG [Unreleased] entry (deployment-mode presets, service accounts, PATs, DI-1 gate)"
    status: "pending"
    assigned_to: ["changelog-generator"]
    dependencies: ["ACT-601"]
  - id: "ACT-604"
    description: "Docs: config reference + admin API docs + SERVICE_CONTRACT.md consistency check"
    status: "pending"
    assigned_to: ["documentation-writer"]
    dependencies: ["ACT-601", "ACT-401"]
  - id: "ACT-605"
    description: "`rf` skill currency note for the `rf serve --mode` CLI surface change"
    status: "pending"
    assigned_to: ["documentation-writer"]
    dependencies: ["ACT-101", "ACT-102"]
  - id: "ACT-606"
    description: "Deferred-items design specs (DF-001 OIDC, DF-002 Postgres migration, DF-003 fine-grained SA scoping)"
    status: "pending"
    assigned_to: ["documentation-writer"]
    dependencies: ["All impl phases"]
  - id: "ACT-607"
    description: "Plan frontmatter + findings-doc finalize (status: completed, commit_refs, files_affected)"
    status: "pending"
    assigned_to: ["documentation-writer"]
    dependencies: ["ACT-603", "ACT-604", "ACT-605", "ACT-606"]

parallelization:
  batch_5: ["ACT-601", "ACT-602", "ACT-603", "ACT-604", "ACT-605", "ACT-606", "ACT-607"]
---
