...
tasks:
- id: P1-001
  description: Extend run_export.py with RunContext dataclass/TypedDict (4 sub-objects).
    Bump schema_version constant to 1.3.
  status: completed
  assigned_to:
  - python-backend-engineer
  dependencies: []
...
- id: P1-002
  description: 'Define RunContext TypeScript interface in src/runs_viewer/types/run.ts
    with 4 optional nullable sub-types. Extend RunExport with context?: RunContext
    | null.'
  status: completed
  assigned_to:
  - python-backend-engineer
  ...
  model_effort: adaptive
- id: P1-003
  description: "Update docs/dev/architecture/rf-run-export-schema.md \xA79 with finalized\
    \ v1.3 context field contract (stub \u2014 full doc in P4). Add changelog row\
    \ for v1.3."
  status: completed
  assigned_to:
  - python-backend-engineer
  ...
  model_effort: adaptive
- id: P1-004
  description: Add backward-compat regression test using schema 1.2 run.json fixture
    (no context key). Assert existing consumers load without errors.
  status: completed
  assigned_to:
  - python-backend-engineer
  dependencies:
  ...
  model_effort: adaptive
- id: P1-005
  description: "Submit schema 1.2\u21921.3 bump for backend-architect re-review per\
    \ frozen-schema policy. Provide field contract, additive+optional proof, OQ-1\
...
- id: SC-P1-2
  ...
  status: pending
- id: SC-P1-3
  description: "Schema doc \xA79 updated with v1.3 contract stub"
  status: pending
- id: SC-P1-4
  description: Backward-compat regression test passes with 1.2 fixture
  status: pending
- id: SC-P1-5
  description: "backend-architect re-review APPROVED (hard gate \u2014 P2 cannot start\
    \ without this)"
  status: pending
- id: SC-P1-6
