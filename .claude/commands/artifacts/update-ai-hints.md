...
SkillMeat follows a strict layered monorepo architecture:
...
2. **UI Imports**: Apps import UI only from `@miethe/ui`, never directly from Radix
...
// App-specific usage
import { PromptCard } from '@miethe/ui'
\`\`\`
```
