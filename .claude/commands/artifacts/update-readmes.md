...
Generates or updates README.md files for directories based on current code structure, following the SkillMeat ≤200 line template with owners and commands.
