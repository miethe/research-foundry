---
name: "source-command-plan-design"
description: "Design system architecture, APIs, and component interfaces with comprehensive specifications"
---

# source-command-plan-design

Use this skill when the user asks to run the migrated source command `plan-design`.
...
- Determine if requirements have already been partially/fully met in current codebase, providing an updated implementation plan if so.
