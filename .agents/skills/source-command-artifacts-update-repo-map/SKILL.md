---
name: "source-command-artifacts-update-repo-map"
description: "Regenerate ai/repo.map.json with current package structure and dependencies"
---

# source-command-artifacts-update-repo-map

Use this skill when the user asks to run the migrated source command `artifacts-update-repo-map`.
