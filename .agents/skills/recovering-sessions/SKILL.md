...
Recover from crashed, failed, or interrupted Codex sessions with automated analysis and resumption planning.

## Why This Skill

Codex sessions can crash during complex multi-agent operations. Recovery without this skill is:
...
```
User: "Codex crashed while I had multiple agents running. Help me recover."
...
1. **Get project path and derive log directory**:
   ...
   # Log directory: ~/.Codex/projects/-Users-name-dev-project/
   LOG_DIR="$HOME/.Codex/projects/$(pwd | sed 's/\//-/g' | sed 's/^-//')"
   ```
...
1. Finding project log directory...
   LOG_DIR: ~/.Codex/projects/-Users-miethe-dev-skillmeat/
