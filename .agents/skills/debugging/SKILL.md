...
Start with `ai/symbols-*.json` (150 tokens) before file exploration (5-15K tokens). See `.Codex/context/key-context/debugging-patterns.md` for full methodology.
...
- `.Codex/context/key-context/debugging-patterns.md` — Symbol-first methodology, bug categories, investigation commands
- `.Codex/context/key-context/symbols-query-playbook.md` — Symbol query recipes
- `.Codex/skills/dev-execution/orchestration/batch-delegation.md` — Batch delegation patterns
- `.Codex/skills/dev-execution/orchestration/agent-assignments.md` — Full agent selection guide
...
| Bug-Fixes Doc | `.Codex/scripts/update-bug-docs.py` for documentation |
