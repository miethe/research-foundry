...
2. Writes a `.Codex/context/meatywiki.md` sidecar in the project root
3. Proposes a diff-confirmed managed block in root `AGENTS.md` referencing the sidecar
...
| `bootstrap/sidecar-template.md` | Canonical content for `.Codex/context/meatywiki.md` sidecar (B3) | 200 |
