...
3. **Converting Sub-Agents to Skills**: Transform existing Codex sub-agent configs to skill format
...
- https://docs.Codex.com/en/docs/agents-and-tools/agent-skills/overview
- https://docs.Codex.com/en/docs/agents-and-tools/agent-skills/best-practices
- https://docs.Codex.com/en/docs/Codex/sub-agents
...
- **Personal Skills**: `~/.Codex/skills/` - Available across all Codex projects
- **Project Skills**: `.Codex/skills/` - Project-specific, shared with team
...
- Template: `.Codex/specs/artifact-structures/skill-spec-template.md`
- Registration: `.Codex/specs/skills-index.md`
...
5. Create in `~/.Codex/skills/` for global availability
