...
**Routing**: All video generation tasks route to Sora 2 via `models.defaults.video_generation` in `.Codex/config/multi-model.toml`.
...
**Cross-references**: Creative workflow routing at `.Codex/skills/dev-execution/orchestration/creative-workflows.md`.
