...
Phase 1: Charter             (delegated to spike-writer / charter-writer in scoping mode)
  ...
  — Template: .Codex/skills/planning/templates/exploration-charter-template.md
  ↓
Phase 2: Parallel legs       (delegated; 1–4 SPIKEs in parallel via /plan:spike --leg-of=<charter>)
  ...
  — Leg catalog and agent routing: .Codex/skills/planning/references/exploration-legs-catalog.md
  ↓
Phase 3: Synthesis           (delegated to documentation-writer or spike-writer)
  ...
  — Template: .Codex/skills/planning/templates/feasibility-brief-template.md
  ↓
...
- Meta plan (full design): `.Codex/plans/plan-explore-pre-commitment-exploration-v1.md`
