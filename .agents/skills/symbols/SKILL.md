...
- Collection (Personal Library) → Projects (Local .Codex/ directories) → Deployment Engine → User/Local Scopes - System architecture description
...
```bash
python .Codex/skills/symbols/scripts/symbol_tools.py
```
...
Symbols understand and validate SkillMeat's layered architecture as defined in Collection (Personal Library) → Projects (Local .Codex/ directories) → Deployment Engine → User/Local Scopes.
