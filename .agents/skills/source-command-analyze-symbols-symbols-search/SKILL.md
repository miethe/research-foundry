---
name: "source-command-analyze-symbols-symbols-search"
description: "Advanced symbol search with filters and contextual relevance"
---

# source-command-analyze-symbols-symbols-search

Use this skill when the user asks to run the migrated source command `analyze-symbols-symbols-search`.
...
### By Architectural Layer (SkillMeat Pattern)
```bash
