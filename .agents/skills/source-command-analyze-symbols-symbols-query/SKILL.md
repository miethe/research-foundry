---
name: "source-command-analyze-symbols-symbols-query"
description: "Query symbols efficiently by name, kind, or domain context"
---

# source-command-analyze-symbols-symbols-query

Use this skill when the user asks to run the migrated source command `analyze-symbols-symbols-query`.
