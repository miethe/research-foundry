...
See also: `.Codex/skills/research-foundry/SKILL.md` (the RF research run skill — covers
...
| Bootstrap config, workspace, seed tree, and AGENTS.md snippet in a host project | `workflows/bootstrap-workflow.md` | mutation — confirm first |
