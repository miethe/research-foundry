---
name: "source-command-analyze-symbols-symbols-update"
description: "Incrementally update symbols graph without full regeneration"
---

# source-command-analyze-symbols-symbols-update

Use this skill when the user asks to run the migrated source command `analyze-symbols-symbols-update`.
