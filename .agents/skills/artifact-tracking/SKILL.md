...
**Scripts location**: `.Codex/skills/artifact-tracking/scripts/`
...
```bash
# Human report
python scripts/validate-phase-completion.py -f .Codex/progress/prd/phase-7-progress.md
...
python scripts/ac-coverage-report.py \
    ...
    --progress .Codex/progress/prd/phase-13-progress.md \
    --progress .Codex/progress/prd/phase-16-progress.md
...
| Bug fixes | `.Codex/worknotes/fixes/bug-fixes-YYYY-MM.md` | ONE per month |
| Observations | `.Codex/worknotes/observations/observation-log-MM-YY.md` | ONE per month |

**Policy**: `.Codex/specs/doc-policy-spec.md`
...
| `meta-plan.schema.yaml` | Workflow/process/tooling plans in `.Codex/plans/` |
...
Field-level guidance: `.Codex/skills/artifact-tracking/schemas/field-reference.md`
